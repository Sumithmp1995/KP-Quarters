    ...
    <div class="box">
        <div class="logo1">
            ...
            <form action=" {{ route('register.custom') }}" method="POST">
                ...
                <input type="hidden" id="form3Example4c" class="form-control" name= "role" value=1 >
                <input type="hidden" id="form3Example4c" class="form-control" name= "applied" value=0 >
                ...
                <div class="mb-2 dropright">
                    <select name="mother_unit" class="form-select col-md-12" onkeyup="this.setAttribute('value', this.value);">
                         <option selected > SELECT YOUR MOTHER UNIT</option>
