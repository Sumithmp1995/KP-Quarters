...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 ml-auto">
                    <div class="col-md-4 text-center" style="width: 155px;">
                    ...
                    <div class="row p-1 border">
                        <div class="col-md-6 ml-auto pt-3">
                    ...
                    <div class="row p-1 border">
                        ...
                        <div class="col-md-6 ml-auto">
                            <input type="text" class="form-control" id="inputoffice" value="{{ $previewData->mob }}"
                ...
                <!-- quarters details -->
                <div class="text-bg-success d-flex justify-content-center mt-4">
                ...
                <div class="row p-1 border">
                    ...
                    <div class="col-md-6 ml-auto">
                        <input type="text" class="form-control" name="priority" value="{{ $previewData->class }}"
                            readonly>
                    </div>
                </div>
                ...
                <div class="row p-1 border">
                    <div class="col-md-6 ml-auto">
                        <label for="inputname"> ALLOTMENT PROCEEDINGS No. </label>
                    </div>
                    <div class="col-md-6 ml-auto">
                ...
                <div class="row p-1 border">
                    ...
                    <div class="col-md-6 ml-auto">
                        <a href="{{ asset('storage/' . $previewData->kseb_noDues) }}" class="btn btn-block border "><u>
                                Click to preview </u></a>
                    </div>
                </div>
                ...
                <div class="row p-1 border">
                    ...
                    <div class="col-md-6 ml-auto">
                        <a href="{{ asset('storage/' . $previewData->kwa_noDues) }}" class="btn btn-block border "><u>
                                Click to preview </u></a>
                    </div>
                </div>
                ...
                <div class="row p-1 border">
                    ...
                    <div class="col-md-4 ml-auto d-flex justify-content-center">
                        <button type="button" data-toggle="modal" data-target="#assetModal"> Assets Details </button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class=" d-flex justify-content-center p-3">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#unitHeadApproveVacate"> Approve
            Request </button>
    </div>

    <!-- Button trigger approve modal -->
    <div class="modal fade" id="unitHeadApproveVacate" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header text-bg-warning p-3">
                    <h5 class="modal-title" id="exampleModalLabel"> Approve Quarters </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    Click to Confirm Vacate request. First applicant from seniority will be allocated the vacant quarters.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <a href=" {{ route('unitHead-approve_vacate', [$vacatteeId]) }} "
                        class="btn btn-primary col-md-4 p3"> Confirm </a>
                </div>
            </div>
        </div>
    </div>
