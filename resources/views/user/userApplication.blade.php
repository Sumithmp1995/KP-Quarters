...
@section('content')
    ...
    <form class=" bg-white border p-4" action="{{ route('user-storeApplication') }}" method="POST"
        ...
        <div class="row pb-3">
            ...
            <div class="form-group col-xl-4 mt-3">
                <label for="ctype">APPLICANT CATEGORY </label>
                <select class="form-control form-control-lg" name="applicant_type" id="type" required
                    placeholder="CHOOSE APPLICANT CATEGORY " onclick="category()">
            ...
            <div class="form-group col-xl-4 mt-3">
                ...
                <select class="form-control form-control-lg" name="rank" id="rank" required onclick="category()">
                    <option value=""> CHOOSE YOUR DESIGNATION </option>
                </select>
                <p id="rankError" class="text-danger"></p>
                @error('rank')
                    <p class="text-danger"> {{ $message }}</p>
                @enderror
            </div>
        ...
        <div class='row border'>
            ...
            <div class="col-md-6 mt-4 ">
                ...
                <input type="text" class="form-control form-control-lg" name="mother_unit" value="{{ $motherUnit }}"
                    id="mother_unit">
                @error('mother_unit')
                    <p class="text-danger"> {{ $message }}</p>
                @enderror
        ...
        <div class="row ">
            <div class="form-group col-md-4 mt-3">
                ...
                <input type="text" class="form-control" id="pay" name="pay" placeholder="Basic Pay" required
                    value="{{ old('pay') }}" onchange="checkPay()">
            ...
            <div class="col-md-4 mt-3 mb-2 dropdown">
                ...
                <select class="form-control form-control-lg" name="present_unit" id="present_unit"
                    onchange="showFileUpload('working_status'); " required>
                    <option selected value=""> CHOOSE YOUR OFFICE OF APPROVING AUTHORITY </option>
        ...
        <div class="row ">
            ...
            <div class="form-group col-md-4 mt-2">
                ...
                <p id="dojError" class="text-danger"></p>
        ...
        <div class="row  mt-3 border p-3">
            ...
            <div class="row ">
                ...
                <div class="form-group col-md-6 mt-3">
                    ...
                    <input type="text" class="form-control" id="inputPin" placeholder="Pin Code" name="pin_code" value={{ old('pin_code') }}>
                    @error('pin_code')
                        <p class="text-danger"> {{ $message }}</p>
                    @enderror
                </div>
        ...
        <input type="checkbox" id="temporaryAddressCheckBox" onclick="showTemporaryAdressField()"  name="differentAddress">
        <label for="inputCity"> <b> Same as Above </b> </label>
        ...
        <div class="row ">
            ...
            <div class="form-group col-md-4 mt-3">
                ...
                <select class="form-control form-control-lg" id="district" placeholder="DISTRICT" name="district">
        ...
        <div class="form-group col-xl-4 mt-3">
            ...
            <input type="text" class="form-control" id="mob" name="mob" placeholder="APPLICANT NAME"
                maxlength="10" value="{{ old('mob') }}" title="Only 10 Digits  allowed" onchange="findMob()">
        ...
        <table class="table table-bordered" id="table">
            ...
            <tr>
                <td>
                    <select class="form-control" id="p1" name="p1" required>
                        <option value=""> Select Priority 1</option>
                        @foreach ($quarters as $quarter)
                            <option value="{{ $quarter->quarters_name }}"> {{ $quarter->quarters_name }} </option>
                        @endforeach
                    </select>
                ...
                <td><button type="button" id="addPriority" class="btn btn-primary col-md-6  " onclick="setPriority()">
                        Check
                    </button>
                </td>
            </tr>
        </table>
        <p id="prioritySuccess" class="text-success"> </p>
        <p id="priorityError" class="text-danger"> </p>
        ...
        <div class="form-group col-md-6 mt-3">
            <input hidden type="hidden" class="form-control" id="application_no" placeholder="House Name"
                name="application_no" value="">
        </div>

        <div class="form-group ">
            <button type="submit" class="btn btn-primary mx-auto"> PREVIEW </button>
        </div>
        <!-- Large modal -->
    </form>
