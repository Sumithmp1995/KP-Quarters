...
@section('content')
    ...
    <form class=" bg-white border p-4" action="{{ route('user-store_application') }}" method="POST"
        ...
        <div class="row pb-3">
            ...
            <div class="form-group col-xl-4 mt-3">
                ...
                <input  type="text" class="form-control" id="inputpen" name="pen" placeholder="PEN No"
                    value="{{ $pen }}" readonly>
                @error('pen')
                    <p class="text-danger"> {{ $message }}</p>
                @enderror
        ...
        <div class='row border'>
            <div class="form-group col-md-6 mt-4">
                ...
                <input type="file" class="form-control" id="photo" name="photo" required onchange="validateCategory()">
            ...
            <div class="col-md-6 mt-4 ">
                ...
                <input type="text" class="form-control form-control-lg" 
                    name="mother_unit" value="{{ $motherUnit }}" id="mother_unit">
                @error('mother_unit')
                    <p class="text-danger"> {{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="row ">
            <div class="form-group col-md-4 mt-3">
                ...
                <input type="text" class="form-control" id="pay" name="pay" placeholder="Pay" required
                    value="{{ old('pay') }}" onclick="checkPay()">
                    ...
                    <td>
                          <select class="form-control" id="p1" name="p1">
                            ...
                            @foreach ($quarters as $quarter)
                               <option value="{{ $quarter->id }}"> {{ $quarter->quarters_name }} </option>
                            @endforeach               
                          </select>
