...
@section('content')
    <form class=" bg-white border border-info">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12 ml-auto">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('ri-viewAssets', $quarters->id) }}">
                            <button type="button" class="btn btn-success py-md-2 "> Assets Manager </button>
                        </a>
                    </div>
            ...
            @endif
            <div class="d-flex justify-content-center m-5"> <a href=" {{ route('ri-viewAllQuarters') }}"> <button
