...
@section('content')
    ...
    <form class=" bg-white border border-info" action="" method="" enctype="multipart/form-data">
        <div class="container-fluid">
            ...
            <div class="row p-1 border">
                ...
                <div class="col-md-6 ml-auto">
                    <input type="text" class="form-control" name="priority" value="{{ $quarters->quarters_name }}" readonly>
                </div>
            </div>
    ...
    <form class=" bg-white border border-info" action="{{ route('ri-storeAssets') }}" method="POST" enctype="multipart/form-data">
        @csrf
