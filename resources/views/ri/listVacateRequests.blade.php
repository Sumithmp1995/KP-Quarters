...
@section('content')
            ...
            <tbody>
                @foreach ($vacattees as $vacattee)
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary py-md-2" data-toggle="modal"
                                data-target="#riVacatePreview"> View Application </button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <!--------------------- Modal ------------------------------->
    <div class="modal fade" id="riVacatePreview" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href=" {{ route('ri-previewVacate', $vacattee->id) }} "><button type="button"
                            class="btn btn-primary">Proceed to Vacate</button> </a>
                </div>
            </div>
        </div>
    </div>
