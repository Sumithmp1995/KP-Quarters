            ...
            <tbody>
                @foreach ($vacattees as $vacattee)
                    <tr>
                        ...
                        {{-- <td>
                        <button type="button" class="btn btn-primary py-md-2"> Print Assets check list </button> 
                        </td> --}}
                        <td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href=" {{ route('ri-previewVacate', $vacattee->id) }} "><button type="button" class="btn btn-primary">Proceed to Vacate</button> </a>
        </div>
      </div>
    </div>
  </div>
